import { _decorator, Component, Node, geometry, Vec3, Vec2, EventTouch, PhysicsSystem, Camera, Quat, tween, easing, Tween, } from 'cc';
...
export class Sample_Cursor extends Component {
    ...
    private _cursorSelect: ICursor;
    private _cursorTarget: ICursor;
